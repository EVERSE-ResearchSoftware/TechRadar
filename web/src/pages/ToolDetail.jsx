    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="glass-panel p-8 mb-8">
                ...
                <ToolIndicators
                    improvesRefs={tool.improvesQualityIndicator}
                    measuresRefs={tool.measuresQualityIndicator}
                />
                {/* ─────────────────────────────────────────────────────────────── */}
                    ...
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <div className="relative group">
                            <button
                                ...
                                className="inline-flex items-center justify-center text-slate-400 hover:text-sky-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2 rounded-full"
                            >
                                <Info size={18} />
                            </button>
                            <div
                            ...
                            >
                                <p className="text-slate-600">Related tools are selected based on shared metadata:</p>
